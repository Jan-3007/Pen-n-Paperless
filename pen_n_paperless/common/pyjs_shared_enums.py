...
ENUM_CLASSES_NAMES = ('Generic', 'Statistics', 'Attributes', 'Armour', 'Weapons', 'History', 'Abilities', 'Tribes', 'Professions', 'Specializations', 'Traits')
